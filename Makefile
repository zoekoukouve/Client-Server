...
# Αρχεία .o
SRCS = parent.cpp $(MODULES)/aid_functions.cpp client.cpp #$(MODULES)/redirection.cpp $(MODULES)/pipes.cpp $(MODULES)/execution.cpp
OBJS = parent.o $(MODULES)/aid_functions.o client.o #$(MODULES)/redirection.o $(MODULES)/pipes.o $(MODULES)/execution.o
